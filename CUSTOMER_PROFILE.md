...
44. [Unique Broadcast](https://github.com/mosi1994/hojreapi-doc/blob/master/CUSTOMER_PROFILE.md#unique-broadcasts) 
  ...
  * **Code:** 200 <br />
    **Content:** 
    ```
        ...
        "_links": {
            "self": {
                "href": "http://localhost/hojreapi/web/broadcasts?username=09121111111&token=x8FRh4z7_TG_WA3ZLWtuMIVtJAnQBnk9&page=1&per-page=300"
            }
        },
        "_meta": {
            "totalCount": 6,
